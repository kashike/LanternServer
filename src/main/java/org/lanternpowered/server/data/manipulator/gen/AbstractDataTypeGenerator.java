...
final class AbstractDataTypeGenerator extends TypeGenerator {
    ...
    @Override
    <M extends DataManipulator<M, I>, I extends ImmutableDataManipulator<I, M>> void generateClasses(String[] classNames,
        ...
        final String mutableImplName = newInternalName(manipulatorType);
        final String immutableImplName = newInternalName(immutableManipulatorType);

        classNames[0] = mutableImplName.replace('/', '.');
        classNames[1] = immutableImplName.replace('/', '.');
        ...
        // Mutable class
        {
            ...
            cwM.visit(V1_8, ACC_PUBLIC + ACC_SUPER, mutableImplName,
                    format("L%s<%s%s>;",
            ...
            }
            {
                ...
                mv.visitMethodInsn(INVOKESPECIAL, nAbstractData, "<init>",
                        "(Lorg/spongepowered/api/data/manipulator/ImmutableDataManipulator;)V", false);
                mv.visitInsn(RETURN);
                mv.visitMaxs(2, 2);
                mv.visitEnd();
            }
            {
                ...
                mv.visitVarInsn(ALOAD, 1);
                mv.visitMethodInsn(INVOKESPECIAL, nAbstractData, "<init>",
                        "(Lorg/spongepowered/api/data/manipulator/DataManipulator;)V", false);
                mv.visitInsn(RETURN);
                mv.visitMaxs(2, 2);
                mv.visitEnd();
            }
            ...
            }
            {
                ...
                mv.visitCode();
                mv.visitFieldInsn(GETSTATIC, mutableImplName, "registrationConsumer", "Ljava/util/function/Consumer;");
                mv.visitVarInsn(ALOAD, 0);
        ...
        // Immutable class
        {
            ...
            cwI.visit(V1_8, ACC_PUBLIC + ACC_SUPER, immutableImplName, format("L%s<%s%s>;",
                    nAbstractImmutableData, dImmutableManipulatorType, dManipulatorType) + signBuilder.toString(), nAbstractImmutableData, interfaces);
            ...
            }
            {
                ...
                mv.visitCode();
                mv.visitFieldInsn(GETSTATIC, immutableImplName, "registrationConsumer", "Ljava/util/function/Consumer;");
                mv.visitVarInsn(ALOAD, 0);
                mv.visitMethodInsn(INVOKEINTERFACE, "java/util/function/Consumer", "accept", "(Ljava/lang/Object;)V", true);
                mv.visitInsn(RETURN);
                mv.visitMaxs(2, 1);
